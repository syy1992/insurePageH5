    ...
    <div id="shubo">
        ...
        <group  :gutter=0>
            ...
            <div class="plan-picker-wrap">
                ...
                <cell primary="content" title="展台面积" :value="selectedPlan.name" :is-link=true @click.native="showPlanPopupPicker = true" :arrow-direction='"down"'></cell>
        ...
        <div class="plan-detail-wrap">
            <group label-width="10em" v-for="(planDetail,index) in selectedPlan.planDetails" :key="index" :gutter=10>
                ...
                <cell  primary="content"  v-for="(planItem,index) in planDetail.planItems" :key="index" :title="planItem.title" :value="planItem.value" class="planItem"></cell>
            </group>

            <group label-width="10em" v-for="(planDetail,index) in selectedPlan.planDetails" :key="index" :gutter=10>
                <cell :title='planDetail.planTitle'  class='subTitle' title="特别约定">
                    <img slot="icon" width="20" style="display:block;margin-right:5px;" :src="picSrc">
                </cell>

                <cell  primary="content"  v-for="(planItem,index) in planDetail.other.value" :key="index" :title="planItem.title" :value="planItem.value" class="planItem"></cell>
            </group>
...
<script>
    import exhibitData from '../../../static/js/hainan.js'
    import {
        XHeader,
        PopupPicker,
        Group,
    ...
    export default {
        ...
        data(){
            return {
                ...
                plans:exhibitData.hainanExhibitData,
            }
        },
        components:{
