<template>
    <div id="applicant">
        ...
        <group  :gutter=10>
            ...
            <selector title="附加投保人豁免保费" :options="list" placeholder="请选择" v-model="isInsure2" id='add' v-if='relationNumber!=0'></selector>
            ...
            <popup v-model="showPayPop" height='70%' style='background: #ffffff'>
                <div class='pay'>
                    ...
                    <group gutter="0">
                        ...
                        <cell title='订单信息'  value-align='right'  v-model='info'  class='default-width'></cell>
                        <cell title='付款方式'  value-align='right'  v-model='payment[radioValue]'   class='default-width' is-link @click.native='showPaySelectFn'></cell>
                    </group>
...
//                radioCheckList: [
//                    {
//                        icon: '/static/images/xianxia.png',
//                        key: '1',
//                        value: '银行转账（线下)'
//                    },
//                    {
//                        icon: '/static/images/checkoutcounter.png',
//                        key: '2',
//                        value: '保司收银台'
//                    },
//                    {
...
//                    },
//                    {
//                        icon: '/static/images/yinlian.png',
//                        key: '9',
//                        value: '其他'
//                    },
//                ],
...
//            ChinaAddressDataSelfDefined,
        ...
        methods: {
            ...
            //显示支付选择
            showPaySelectFn(){
//                console.log('radioCheckList.value1='+this.radioCheckList.value)
//                let v=''
//                for(let radioValue in this.radioCheckList){
//                    v= this.radioCheckList[radioValue].value
//                }
//                this.payment=v
//                console.log(v)
...
//            validateAge(){
//                let strIdCard=this.tool.idcardConvert(this.applicantIdCard)
//                let age=this.tool.GetAge(strIdCard);
//                if(age<18){
//                    return false
//                }
//            },
...
//                      this.professionCode=node.code;
            ...
            //获取银行列表
            getBankList(){
//                let url='http://127.0.0.1:8080/mockdata/getBankList.js';
...
//              isInsBenSame: 1,//被保险人是否为受益人
                ...
                this.$http.post(process.env.BASE_URL+process.env.commonPort+'/insurance/fosun/apply',this.copyUserData).then(({data}) => {
//                this.$http.post(process.env.BASE_URL+':8765/insurance/fosun/apply',this.copyUserData).then(({data}) => {
                    switch(data.resCode){
                        case '0000'://成功
